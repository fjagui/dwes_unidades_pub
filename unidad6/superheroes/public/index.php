...
//Cargamos en una cadena el nombre de la clase contralodr de errores.
$errorControllerClass = ErrorController::class;
...
$router->add(array(
    ...
    'action' => [SuperHeroeController::class, 'IndexAction'] // Acción a ejecutar
));
...
if ($route) {
    ...
    $controller->ShowAction("Error 404: Not found");
